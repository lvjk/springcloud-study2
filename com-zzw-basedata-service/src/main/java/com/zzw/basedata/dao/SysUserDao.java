...
public class SysUserDao {
	...
	public List<SysUser> selectAll() {
		try {			
			return jdbcTemplate.query("select * from sys_user", new SysUserRowMapper());
	...
	public SysUser selectOne(Serializable id) {
		try {			
			return jdbcTemplate.queryForObject("select * from sys_user where id = ?", new Object[] { id }, SysUser.class);
		} catch (DataAccessException e) {
			throw e;
		}
