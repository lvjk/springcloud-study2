...
public class UserDao {
	 ...
	 */
	@Transactional(readOnly = true)
	public User selectOne(Serializable id) {
		try {			
...
class UserRowMapper implements RowMapper<User> {
	...
	public User mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		bean.setLoginphone(rs.getString("loginphone"));
		bean.setMsgcheck(rs.getBoolean("msgcheck"));
		bean.setName(rs.getString("name"));
		bean.setOpenpsw(rs.getString("openpsw"));
		bean.setPsw(rs.getString("psw"));
		bean.setRemark(rs.getString("remark"));
		bean.setFaceToken(rs.getString("face_token"));
		bean.setWechatBing(rs.getBoolean("wechat_bing"));
		bean.setWechatOpenid(rs.getString("wechat_openid"));
		return bean;
	}
