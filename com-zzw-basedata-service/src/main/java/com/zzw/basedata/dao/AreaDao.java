...
public class AreaDao {
	 ...
	 */
	@Transactional(readOnly = true)
	public Area selectOne(Serializable id) {
		try {			
			return jdbcTemplate.queryForObject("select * from area where id = ?", new Object[] { id }, Area.class);
		} catch (DataAccessException e) {
			throw e;
		}
...
class AreaRowMapper implements RowMapper<Area> {
	...
	public Area mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		bean.setIsuse(rs.getBoolean("isuse"));
