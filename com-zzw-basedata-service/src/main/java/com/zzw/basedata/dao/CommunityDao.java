...
public class CommunityDao {
	...
	public List<Community> selectAll() {
		try {			
			return jdbcTemplate.query("select * from community", new CommunityRowMapper());
	 ...
	 */
	@Transactional(readOnly = true)
	public Community selectOne(Serializable id) {
		try {			
			return jdbcTemplate.queryForObject("select * from community where id = ?", new Object[] { id }, Community.class);
		} catch (DataAccessException e) {
			throw e;
		}
...
class CommunityRowMapper implements RowMapper<Community> {
	@Override
