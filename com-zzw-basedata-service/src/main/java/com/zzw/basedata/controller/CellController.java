...
import com.zzw.basedata.dao.CellDao;
...
public class CellController {
	...
	@PostMapping("/add")
	public ResultObject add(Cell bean) {
		ResultObject result = new ResultObject();
		/*
		String sql = "insert into cell(id,name)values(?,?)";
	...
	public ResultObject upd(@PathVariable Serializable id,Cell bean) {
		ResultObject result = new ResultObject();
		/*
		String sql = "update cell set name = ? area = ? where id = ?";
		Object[] params = new Object[]{id};
		*/
		String sql = null; 
		Object[] params = null;
