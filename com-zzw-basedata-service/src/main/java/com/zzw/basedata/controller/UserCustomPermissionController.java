...
import com.zzw.basedata.dao.UserCustomPermissionDao;
...
public class UserCustomPermissionController {
	...
	@PostMapping("/add")
	public ResultObject add(UserCustomPermission bean) {
		ResultObject result = new ResultObject();
		/*
		String sql = "insert into user_custom_permission(id,name)values(?,?)";
	...
	public ResultObject upd(@PathVariable Serializable id,UserCustomPermission bean) {
		ResultObject result = new ResultObject();
		/*
		String sql = "update user_custom_permission set name = ? area = ? where id = ?";
		Object[] params = new Object[]{id};
		*/
		String sql = null; 
		Object[] params = null;
