...
import com.zzw.basedata.dao.DoorCardDao;
import com.zzw.domain.basedata.DoorCard;
...
public class DoorCardController {
	...
	@PostMapping("/add")
	public ResultObject add(DoorCard bean) {
		ResultObject result = new ResultObject();
		/*
		String sql = "insert into door_card(id,name)values(?,?)";
	...
	public ResultObject upd(@PathVariable Serializable id,DoorCard bean) {
		ResultObject result = new ResultObject();
		/*
		String sql = "update door_card set name = ? area = ? where id = ?";
		Object[] params = new Object[]{id};
		*/
		String sql = null; 
		Object[] params = null;
