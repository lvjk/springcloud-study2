...
import com.zzw.basedata.dao.PermissionDao;
import com.zzw.bean.ResultObject;
import com.zzw.domain.basedata.Permission;
...
public class PermissionController {
	...
	@PostMapping("/add")
	public ResultObject add(Permission bean) {
		ResultObject result = new ResultObject();
		/*
	...
	public ResultObject upd(@PathVariable Serializable id,Permission bean) {
		ResultObject result = new ResultObject();
		/*
		String sql = "update permission set name = ? area = ? where id = ?";
		Object[] params = new Object[]{id};
		*/
		String sql = null; 
		Object[] params = null;
