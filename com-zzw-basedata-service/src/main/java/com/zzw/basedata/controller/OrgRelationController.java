...
import com.zzw.basedata.dao.OrgRelationDao;
...
public class OrgRelationController {
	...
	@PostMapping("/add")
	public ResultObject add(OrgRelation bean) {
		ResultObject result = new ResultObject();
		/*
		String sql = "insert into org_relation(id,name)values(?,?)";
	...
	public ResultObject upd(@PathVariable Serializable id,OrgRelation bean) {
		ResultObject result = new ResultObject();
		/*
		String sql = "update org_relation set name = ? area = ? where id = ?";
		Object[] params = new Object[]{id};
		*/
		String sql = null; 
		Object[] params = null;
